...
The objective of this project is to gain hands-on experience with AWS EC2 and ECR by containerizing a simple HTML page using Docker and deploying it with Nginx as the web server.
